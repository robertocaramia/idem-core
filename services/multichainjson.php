...
$multchain_conn = new Multichain('username','password');
...
class Multichain
{
     ...
     * @param string $url
     */
    public function __construct($username, $password, $host, $port, $url = null)
    {
