					...
					<div class="panel-body">
						<form class="form-horizontal form-bordered" method="POST" id="newuser" action="user-genesis.php">
							...
							<div class="form-group">
								...
								<div class="col-md-6">
									<input name="birthDate" id="birthDate" placeholder="<?php echo _('dd/mm/yyyy'); ?>" class="form-control" value="" required autocomplete="off">
								</div>
							</div>
...
<script>
  ...
  $(document).ready(function() {
	    $("#birthDate").datepicker({
		    format: 'dd/mm/yyyy',
		    startDate: '01/01/1900', // massimo nato nel 1900
		    endDate: new Date() // max dieci anni
	    });
	});
